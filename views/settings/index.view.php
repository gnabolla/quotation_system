...
<div class="card">
    ...
    <div class="card-body">
        ...
        <!-- Add this new card after the settings form: -->
        <div class="card mt-4">
            <div class="card-header bg-light">
                <h5>PDF Template Management</h5>
            </div>
            <div class="card-body">
                <p>
                    To ensure quotations match the exact layout of the official ISU RFQ form,
                    you need to upload the original PDF form as a template.
                </p>
                ...
                ?>
                    <div class="alert alert-success">
                        <strong>Template status:</strong> Uploaded (Last modified: <?= date('F j, Y, g:i a', filemtime($templateFile)) ?>)
                    </div>
                <?php else: ?>
                    <div class="alert alert-warning">
                        <strong>Template status:</strong> Not uploaded yet. Please upload the official RFQ template.
                    </div>
                <?php endif; ?>

                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="/template/upload" class="btn btn-outline-primary">
